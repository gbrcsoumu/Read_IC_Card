...
Public Class ClsWinSCard
    ...
    ' WinSCard API
    '==============
    <DllImport("winscard.dll", EntryPoint:="SCardEstablishContext", CharSet:=CharSet.Unicode, CallingConvention:=CallingConvention.StdCall)>
    Private Shared Function SCardEstablishContext(
        ByVal dwScope As UInteger,
        ByVal pvReserved1 As IntPtr,
        ByVal pvReserved2 As IntPtr,
        ByRef phContext As IntPtr
    ) As UInteger
    End Function

    <DllImport("winscard.dll", EntryPoint:="SCardListReaders", CharSet:=CharSet.Unicode, CallingConvention:=CallingConvention.StdCall)>
    Private Shared Function SCardListReaders(
    ...
    <DllImport("winscard.dll", EntryPoint:="SCardGetStatusChange", CharSet:=CharSet.Unicode, CallingConvention:=CallingConvention.StdCall)>
    Private Shared Function SCardGetStatusChange(
        ByVal hContext As IntPtr,
        ByVal dwTimeout As Integer,
        ByRef rgReaderStates As SCARD_READERSTATE,
        ByVal cReaders As Integer
    ) As UInteger
    End Function

    <DllImport("winscard.dll", EntryPoint:="SCardConnect", CharSet:=CharSet.Unicode, CallingConvention:=CallingConvention.StdCall)>
    Private Shared Function SCardConnect(
        ByVal hContext As IntPtr,
        ByVal szReader As String,
        ByVal dwShareMode As UInteger,
        ByVal dwPreferredProtocols As UInteger,
        ByRef phCard As IntPtr,
        ByRef pdwActiveProtocol As IntPtr
    ) As UInteger
    End Function

    <DllImport("winscard.dll", EntryPoint:="SCardStatus", CharSet:=CharSet.Unicode, CallingConvention:=CallingConvention.StdCall)>
    Private Shared Function SCardStatus(
        ByVal hCard As IntPtr,
        ByVal szReaderName As StringBuilder,
        ByRef pcchReaderLen As UInteger,
        ByRef pdwState As UInteger,
        ByRef pdwProtocol As UInteger,
        ByVal pbAtr As Byte(),
        ByRef pcbAtrLen As Integer
    ) As UInteger
    End Function

    <DllImport("winscard.dll", EntryPoint:="SCardTransmit", CharSet:=CharSet.Unicode, CallingConvention:=CallingConvention.StdCall)>
    Private Shared Function SCardTransmit(
        ByVal hCard As IntPtr,
        ...
        ByRef RecvBuffLen As Integer
    ) As UInteger
    End Function

    <DllImport("winscard.dll", EntryPoint:="SCardDisconnect", CharSet:=CharSet.Unicode, CallingConvention:=CallingConvention.StdCall)>
    Private Shared Function SCardDisconnect(
        ByVal hCard As IntPtr,
        ByVal Disposition As Integer
    ) As UInteger
    End Function
    ...
    <DllImport("winscard.dll", EntryPoint:="SCardReleaseContext", CharSet:=CharSet.Unicode, CallingConvention:=CallingConvention.StdCall)>
    ...
    ' Win32 API
    '===========
    <DllImport("kernel32.dll", EntryPoint:="LoadLibrary", CharSet:=CharSet.Unicode, CallingConvention:=CallingConvention.StdCall)>
    Private Shared Function LoadLibrary(ByVal lpFileName As String) As IntPtr
    End Function

    <DllImport("kernel32.dll", EntryPoint:="FreeLibrary", CharSet:=CharSet.Unicode, CallingConvention:=CallingConvention.StdCall)>
    Private Shared Sub FreeLibrary(ByVal handle As IntPtr)
    End Sub

    <DllImport("kernel32.dll", EntryPoint:="GetProcAddress", CharSet:=CharSet.Unicode, CallingConvention:=CallingConvention.StdCall)>
    ...
    Private writeBuffer_SPAD0 As Byte() = New Byte() {&HFF, &HD6, &H0, &H0, 16, &H30, &H31, &H32, &H33,
                                                      &H34, &H36, &H37, &H38, &H39, &H2A, &H2A, &H2A, &H2A, &H2A, &H2A, &H2A, &H0} 'UPDATE BINARY
    Private clearBuffer_SPAD0 As Byte() = New Byte() {&HFF, &HD6, &H0, &H0, 16, &H0, &H0, &H0, &H0,
    ...
    Public Sub New(ByVal CardMasterKeyString As String)
        ...
        Me.CardMasterKey = New Byte() {&H0, &H0, &H0, &H0, &H0, &H0, &H0, &H0,
    ...
    Private Function FelicaReadBinaryWithMac_A(ByVal adr As UInt16, ByRef chr As Byte(), ByRef chrlen As Integer) As Boolean
        ...
        Dim commandFeliCaRead As Byte() = New Byte() {&HFF, &HC2, &H0, &H1,
                                      &H14,
                                      &H95,
                                      &H12, &H12,
                                      &H6,
    ...
    Private Function FelicaUpdateBinary(ByVal adr As UInt16, ByRef chr As Byte(), ByRef chrlen As Integer) As Boolean
        ...
        Dim commandFeliCaWrite As Byte() = New Byte() {&HFF, &HC2, &H0, &H1,
                                              &H22,
                                              &H95,
                                              &H20, &H20,
                                              &H8,
